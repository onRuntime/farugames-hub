...
public enum Item {
	...
	MENU_COSMETICS_OPEN("hub", null, 4, new ItemBuilder(ItemType.CUSTOM_HEAD, "http://textures.minecraft.net/texture/b4cc193f6edd88a772b93eea3abd7520ce945d73864a62fec1ff5c2f94e25").withName("§bCosmetics")),
	MENU_COSMETICS_CLOSE("hub", null, 4, new ItemBuilder(ItemType.CUSTOM_HEAD, "http://textures.minecraft.net/texture/b4fcaaea16eb7271067d8c8b3274de0ce762fa14f886a829dacf0457630eab").withName("§bCosmetics"));
