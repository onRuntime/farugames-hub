...
public enum Item {
	...
	//MENU_GAME("hub", null, 0, new HeadBuilder().("http://textures.minecraft.net/texture/a6bc364673c34dc34a9578292f30aa9f2d4b9468115b86129e76786cff8299d").withName("§cGame Menu").build()),
	//MENU_GAME("hub", null, 0, new ItemStack),
